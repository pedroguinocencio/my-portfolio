...
const translations = {
    pt: {
        ...
        'services.subtitle': 'Desenvolvimento, documentação e social media com visão técnica e estratégica.',
        'services.web.title': 'Software Development',
        'services.web.description': 'Criação de páginas, interfaces e soluções digitais com estrutura limpa, responsividade e atenção à experiência de uso.',
        'services.social.title': 'Documentation',
        'services.social.description': 'Organização de processos, fluxos e materiais técnicos para deixar projetos mais claros, replicáveis e fáceis de manter.',
        'services.ui.title': 'Social Media Design',
        'services.ui.description': 'Peças para redes sociais com direção visual, leitura de público e noções de marketing para campanha, posicionamento e rotina de conteúdo.',
    ...
    en: {
        ...
        'services.subtitle': 'Development, documentation and social media with technical and strategic thinking.',
        'services.web.title': 'Software Development',
        'services.web.description': 'Pages, interfaces and digital solutions with clean structure, responsive behavior and attention to the user experience.',
        'services.social.title': 'Documentation',
        'services.social.description': 'Organizing processes, flows and technical materials so projects are clearer, repeatable and easier to maintain.',
        'services.ui.title': 'Social Media Design',
        'services.ui.description': 'Social media assets with visual direction, audience awareness and marketing knowledge for campaigns, positioning and content routines.',
